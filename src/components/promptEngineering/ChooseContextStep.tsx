  ...
  return (
    <div className=" rounded-lg shadow-sm border-[0.5px] border-gold/30 p-6 mb-6">
      <div className="flex items-center mb-4">
        <div className="bg-gold text-ivory rounded-full w-8 h-8 flex items-center justify-center font-semibold mr-3">2</div>
        <h2 className="text-xl font-semibold text-charcoal">Choose Context Type</h2>
      </div>
            ...
            className={`p-4 rounded-lg border-2 transition-all duration-200 text-center flex flex-col items-center justify-center ${
              selectedContext === id
                ? id === 'freeform'
                  ...
                  : 'bg-gold border-[0.5px] border-gold/30 text-ivory'
