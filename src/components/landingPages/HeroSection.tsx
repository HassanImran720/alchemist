...
const HeroSection: React.FC = () => {
  return (
    <section className="flex flex-col items-center justify-center min-h-[70vh] w-full text-center relative z-10 px-4 sm:px-8">
      <h1 className="text-gold font-heading text-4xl sm:text-5xl md:text-6xl font-bold leading-tight mb-4">
        From Raw Thought to<br className="hidden md:block" /> Prompted Gold.
      </h1>
