...
<div className="w-full md:w-2/3 p-4 flex justify-center">
  <div className="bg-gold w-full md:max-w-2xl p-6 rounded-lg flex flex-col items-center justify-center min-h-[300px]">
    <p className="text-black font-medium text-sm leading-relaxed text-center">
      {getCurrentContent()}
    </p>
